# Cuisson has no server

Cuisson stores everything on the device and talks to no backend of ours. Sync, when a user
...
running costs at zero, and is the property that distinguishes Cuisson from every
